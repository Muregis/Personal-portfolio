...
const Hero1 = () => {
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#0c0414] text-white">
      <div className="absolute right-[-30rem] top-[-40rem] z-0 flex skew-[-40deg] rotate-[-20deg] gap-[10rem] blur-[4rem] opacity-50">
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
      </div>
      <div className="absolute right-[-50rem] top-[-50rem] z-0 flex skew-[-40deg] rotate-[-20deg] gap-[10rem] blur-[4rem] opacity-50">
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
        <div className="h-[20rem] w-[10rem] bg-linear-90 from-white to-blue-300" />
      </div>
      <div className="absolute right-[-60rem] top-[-60rem] z-0 flex skew-[-40deg] rotate-[-20deg] gap-[10rem] blur-[4rem] opacity-50">
